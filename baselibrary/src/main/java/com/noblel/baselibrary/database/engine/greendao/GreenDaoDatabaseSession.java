...
public class GreenDaoDatabaseSession<T> implements IDatabaseSession<T> {
    ...
    public GreenDaoDatabaseSession(DaoMaster.DevOpenHelper helper,
                                   AbstractDao<T, ?> dao, Class<T> clazz) {
...
//                    //创建数据表XXXDao
     ...
     * @param ifNotExists
     */
    private void createAllTables(Class<?> clazz, Database database, boolean ifNotExists) {
        try {
            Class<? extends AbstractDao<?, ?>> daoClass = GreenDaoUtil.getDaoClass(clazz);
     ...
     * @param ifExists
     */
    private void dropAllTables(Class<?> clazz, Database database, boolean ifExists) {
        try {
            Class<? extends AbstractDao<?, ?>> daoClass = GreenDaoUtil.getDaoClass(clazz);
